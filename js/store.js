...
const ProductStore = {
  ...
  add(productData) {
    ...
    const product = {
      ...
      optionValues: this._sanitizeUrlList(productData.optionValues),
  ...
  update(id, patch) {
    ...
    if (patch.optionValues !== undefined) product.optionValues = this._sanitizeUrlList(patch.optionValues);
  ...
  importJSON(jsonString) {
    ...
    parsed.forEach((item) => {
      ...
      const product = {
        ...
        optionValues: this._sanitizeUrlList(item.optionValues),
