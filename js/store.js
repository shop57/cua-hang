...
const ProductStore = {
  ...
  add(productData) {
    ...
    const product = {
      ...
      variants: this._sanitizeUrlList(productData.variants),
  ...
  update(id, patch) {
    ...
    if (patch.variants !== undefined) product.variants = this._sanitizeUrlList(patch.variants);
  ...
  importJSON(jsonString) {
    ...
    parsed.forEach((item) => {
      ...
      const product = {
        ...
        variants: this._sanitizeUrlList(item.variants),
